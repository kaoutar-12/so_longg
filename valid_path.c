...
/*   Updated: 2023/05/24 09:20:59 by kmouradi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (game->path_map[posX - 1][posY] == '0'
	|| game->path_map[posX - 1][posY] == 'C')
		game->path_map[posX - 1][posY] = 'P';
	if (game->path_map[posX + 1][posY] == '0'
	|| game->path_map[posX + 1][posY] == 'C')
		game->path_map[posX + 1][posY] = 'P';
	if (game->path_map[posX][posY - 1] == '0'
	|| game->path_map[posX][posY - 1] == 'C')
		game->path_map[posX][posY - 1] = 'P';
	if (game->path_map[posX][posY + 1] == '0'
	|| game->path_map[posX][posY + 1] == 'C')
		game->path_map[posX][posY + 1] = 'P';
